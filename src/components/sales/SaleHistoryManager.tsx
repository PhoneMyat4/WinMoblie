...
import { Sale, PaymentMethod, ShopSettings } from '../../types';
                        ...
                        <div className="flex items-center justify-center gap-1.5">
                          ...
                          {!isRefunded && (
                            <button
                              ...
                              className="px-2 py-1 text-rose-600 hover:bg-rose-50 text-[11px] font-semibold rounded-lg transition-colors cursor-pointer"
