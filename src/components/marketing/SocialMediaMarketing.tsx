      ...
      {activeTabSubView === 'workflow' && (
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div id="section-1-product-lookup" className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-5 shadow-xs">
              <div className="flex items-center justify-between mb-3">
                ...
                <span className="text-xs text-slate-500 dark:text-slate-400">Barcode / SKU Scanner</span>
              </div>
              ...
              <div className="flex items-center gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm text-[#e1ebee] focus:outline-hidden focus:ring-2 focus:ring-blue-500"
                  />
                  {socialState.skuOrBarcode && (
                    <button
                      type="button"
                ...
                <button
                  ...
                  className="px-4 py-2.5 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 rounded-xl border border-slate-200 dark:border-slate-700 font-medium text-sm flex items-center gap-2 transition-colors whitespace-nowrap"
                >
            ...
            <div id="section-2-media-management" className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-5 shadow-xs">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full bg-blue-600 text-white flex items-center justify-center text-xs font-bold">
                    2
              ...
              <div id="ai-commercial-visual-generator" className="mt-4 p-3.5 bg-indigo-50/60 dark:bg-indigo-950/30 rounded-xl border border-indigo-100 dark:border-indigo-900/60">
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 bg-white dark:bg-slate-800 border border-indigo-200 dark:border-indigo-800 rounded-lg text-xs text-[#ffffff] focus:outline-hidden focus:ring-1 focus:ring-indigo-500"
                  />
                  <button
                    type="button"
                    ...
                    className="px-3.5 py-2 bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-400 text-white rounded-lg text-xs font-semibold flex items-center gap-1.5 transition-colors whitespace-nowrap cursor-pointer shadow-xs"
                  >
            ...
            <div id="section-3-ai-copywriting" className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-5 shadow-xs">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full bg-blue-600 text-white flex items-center justify-center text-xs font-bold">
                    3
                ...
                <span className="text-xs text-slate-500">Few-Shot Tone Conditioning</span>
              </div>
              ...
              <div className="mb-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 rounded-lg text-xs font-medium border border-slate-200 dark:border-slate-700 flex items-center gap-1.5 transition-colors whitespace-nowrap"
                  >
                    <Upload className="w-3.5 h-3.5" />
                    <span>Upload .txt File</span>
                  </button>

                  <div className="flex-1 truncate text-xs text-slate-500 dark:text-slate-400 bg-slate-50 dark:bg-slate-800/50 px-3 py-2 rounded-lg border border-slate-200 dark:border-slate-700/60">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div id="section-4-draft-preview" className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-5 shadow-xs">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full bg-blue-600 text-white flex items-center justify-center text-xs font-bold">
                    4
                ...
                <span className="text-xs text-slate-500">Editable Live Preview</span>
              </div>
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  className="w-full p-3 bg-slate-50 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl text-xs text-[#ffffff] font-sans focus:outline-hidden focus:ring-2 focus:ring-blue-500"
                />
            ...
            <div id="section-5-publishing" className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-5 shadow-xs">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full bg-blue-600 text-white flex items-center justify-center text-xs font-bold">
                    5
